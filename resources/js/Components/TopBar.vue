            ...
            <div class="mobile-topbar visible-xs">
                <div class="container">
                    <div class="topbar-flex">
                        <p><Link :href="route('dashboard')"><span class="fa fa-angle-left"></span></Link></p>
                        <h4>{{ type }}</h4>
                        <p>
                            <a
                                role="button"
                    ...
                    <p class="mobile-filtericon hidden">
                        <a href="#" data-toggle="modal" data-target="#myModal2">Filter <img src="/images/filter-list.png" alt="filter"></a>
                    </p>
