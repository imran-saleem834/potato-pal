...
import Details from '@/Pages/Grading/Details.vue';
...
const gradings = ref(props.single || {});
            ...
            <template v-else>
              ...
              <div v-if="activeTab" class="row align-items-center">
                <div class="col-12 col-sm-4 col-lg-3 mb-3 mb-sm-4">
                  <h4 class="m-0">Grading Details</h4>
                </div>
                <div class="col-12 col-sm-4 col-lg-5 mb-3 mb-sm-4">
                  <input v-model="search" type="text" class="form-control" placeholder="Search Gradings..." />
                </div>
                <div class="col-12 col-sm-4 col-lg-4 mb-3 mb-sm-4 text-end">
                  <button class="btn btn-black" :disabled="isNewItemRecord" @click="isNewItemRecord = true">
                    <i class="bi bi-plus-lg"></i> Add grading
                  </button>
                </div>
              </div>
              <Details
              ...
              <div class="float-end">
                <Pagination :links="gradings.links" />
              </div>
            </template>
          </div>
          <div class="col-12" v-if="gradings?.data?.length <= 0 && !isNewRecord">
